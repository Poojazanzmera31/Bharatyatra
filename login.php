...
<head>
    ...
    * {
    ...
    @media (max-width: 480px) {
        .form-box {
            height: auto; /* Allow form to adjust height */
        ...
        .liw {
            font-size: 12px; /* Adjust link text size */
        }
    }
    ...
    @media (min-width: 1025px) {
        .form-box {
            padding: 55px; /* Maintain larger padding */
        }
        ...
        <div class="form-box">
            ...
            <form method="POST" action="loginvalidation.php">
                <div class="input-group">
                    ...
                    <p><span class="text">Don't have an Account??</span> <a href="signup.php"> Click Here!</a></p>
                </div>
                <div class="btn-field">
